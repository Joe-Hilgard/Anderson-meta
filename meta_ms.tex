...
On the topic of scientific transparency, we note that the clear and accessible archival of meta-analytic data is a tremendous boon to research transparency. We commend Anderson and colleagues for sharing the data and for responding to questions as to how best reproduce their analyses. We suggest that future meta-analyses routinely include the data, funnel plots, and other supplementary materials, and that other researchers be encouraged to inspect and reproduce meta-analyses \citep{Lakens:etal:InPress}. Meta-analyses that cannot be inspected or reproduced should be regarded with concern.
>>>>>>> a3aa4f331db441a4a96d2cdd1e2dffe90710887c
...
Another limitation is that our re-analysis is limited to the \citet{Anderson:etal:2010} meta-analysis. Since that meta-analysis was published, a second meta-analysis by \citet{Grietemeyer:Mugge:2014} synthesized the research literature made available after 2009. 
%The first version of this manuscript suggested that the effects of violent games were somehow {\em underestimated}, showing that trim-and-fill suggested a larger effect ($r = .25$) than did na{\"i}ve meta-analysis ($r = .20$). Our inspection found errors that, once brought to the authors' attention, revised this trim-and-fill estimate to $r = .19$. 
This newer dataset may be less contaminated by bias and may provide stronger evidence of violent-game effects in experimental paradigms; we will examine this dataset in the future.
