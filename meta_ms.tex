...
% TODO: Remove speculation about relative proportions of dissertation vs. non-diss dark lit
% TODO: Be gentler to Anderson et al., considering that these techniques did not exist then
% TODO: Cite other criticisms of trim-and-fill besides Simonsohn et al 2014b.
...
% TODO: Find a citation for Reviewer 2's point about heterogeneity?
% TODO: Look into how heterogeneity influences other estimators?
...
% TODO: Make sure this is explained clearly enough per Reviewer 3's concerns.
In the original dataset, \citet{Anderson:etal:2010} coded all effect sizes in terms of Pearson $r$, then converted these to Fisher's $z$-scores with standard error of $1/sqrt(N-3)$. We retain this approach, which has the added benefit of providing standard errors that are not a function of effect size, which can lead to the spurious detection of small-study effects.

% TODO: Make it clear we're not talking about the partials.
...
The available code for generating $p$-curve estimates provides estimates in terms of Cohen's $d$. We converted these to Pearson $r$ for consistency of presentation.
