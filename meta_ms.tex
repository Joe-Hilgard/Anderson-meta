...
% NEW NOTE: Bartholow & Anderson (2002) did not pilot test for equivalence, yet was rated as best-practices.
% No pilot, just that "This game seemed to us engaging and interesting enough to be appropriately compared to the \em{Mortal Kombat} game.
% Bartholow, Sestir, & Davis (2005) didn't either, yet was rated as best-practices.
% Myst had previously been inspected in Anderson & Dill (2000) but Unreal Tournament was novel and untested.
...
Some have characterized this as an ``extensive'' test for publication bias \citep{some-chucklehead}, but we are not satisfied. In examining the funnel plots behind the study's main findings, we found naked, obvious symmetry. %Who's the chucklehead? Bushman et al reply to Elson & Ferguson?
