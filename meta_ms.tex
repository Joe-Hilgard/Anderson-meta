...
%Other p-hacking notes to round this out?
...
For $p$-uniform, we use the ``puniform'' package provided by van Aert at https://github.com/RobbievanAert/puniform. Analysis was performed using the correlations and sample sizes as entered by Anderson et al. The package's default method for the aggregation of $p$-values was used. % Reference entry needed? Seems that citing the p-uniform paper is good enough.
...
% TODO: Again point out cases where I^2 is large enough for concern.
